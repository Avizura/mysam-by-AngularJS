...
var Jarvis = function () {
    function Jarvis($scope, $state, Recognizer, Classifier) {
        var _this = this;
    ...
    _createClass(Jarvis, [{
        key: 'runAction',
        value: function runAction(input) {
            if (!input) return; //error msg here
            var classification = this.Classifier.classify(input);
...
angular.module('Jarvis').controller('mainCtrl', Jarvis);